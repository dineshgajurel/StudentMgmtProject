...
public class StudentScreen extends JFrame {
	...
	public StudentScreen() {
		setIconImage(Toolkit
				.getDefaultToolkit()
				.getImage(
						"C:\\Users\\DELL\\Desktop\\Student-Management-System-project.jpg"));
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 865, 512);
	...
	private JLabel getLblActiveUser() {
		if (lblActiveUser == null) {
			...
			lblActiveUser.setBounds(335, 11, 72, 23);
		}
	...
	private JButton getLogout() {
		if (logout == null) {
			...
			logout.setIcon(new ImageIcon(
					"C:\\Users\\DELL\\Desktop\\logout_button_green.png"));
			logout.setBounds(662, 11, 38, 38);
		}
		return logout;
	}
	...
	private JPanel getStudentForm() {
		if (studentForm == null) {
			...
			studentForm.setBounds(10, 45, 524, 167);
	...
	private JLabel getLblLogOut() {
		if (lblLogOut == null) {
			...
			lblLogOut.setBounds(575, 11, 78, 27);
		}
		return lblLogOut;
	}
	...
	private JTextField getAddress() {
		if (address == null) {
			...
			address.setBounds(250, 112, 86, 23);
	...
	private JButton getSave() {
		if (save == null) {
			save = new JButton("");
			save.setIcon(new ImageIcon("C:\\Users\\DELL\\Desktop\\images.png"));
	...
	private JScrollPane getScrollPane() {
		if (scrollPane == null) {
			...
			scrollPane.setBounds(20, 253, 806, 153);
	...
	private JLabel getLblNewLabel_5() {
		if (lblNewLabel_5 == null) {
			...
			lblNewLabel_5.setBounds(72, 219, 173, 23);
		}
	...
	private JLabel getLblNewLabel_6() {
		if (lblNewLabel_6 == null) {
			...
			lblNewLabel_6.setBounds(317, 223, 137, 14);
		}
	...
	private JButton getExit() {
		if (exit == null) {
			...
			exit.setIcon(new ImageIcon(
					"C:\\Users\\DELL\\Desktop\\images (6).jpg"));
			exit.setBounds(764, 417, 31, 31);
	...
	private JLabel getLblExitProgram() {
		if (lblExitProgram == null) {
			...
			lblExitProgram.setBounds(644, 417, 110, 23);
		}
	...
	private JLabel getLblNewLabel_7() {
		if (lblNewLabel_7 == null) {
			...
			lblNewLabel_7.setBounds(303, 424, 227, 31);
		}
	...
	private JLabel getLblNewLabel_9() {
		if (lblNewLabel_9 == null) {
			...
			lblNewLabel_9.setIcon(new ImageIcon("C:\\Users\\DELL\\Desktop\\Student-Management-System-project.jpg"));
			lblNewLabel_9.setBounds(538, 59, 311, 153);
		}
